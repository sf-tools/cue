...
export const SYSTEM_PROMPT = xml({
  ...
  interactionTriggers: {
    priority:
      'Treat these as strong default triggers unless the surrounding request clearly means something else.',
    rules: [
  ...
  verification: {
    policy:
      'After making changes, run the relevant verification commands for the affected code whenever available.',
    ...
    sections: [
      {
        ...
        include: [
          ...
          'clarifications, constraints, and approvals the user specified',
        ],
      },
      {
        name: 'Current State',
...
export const createInitialMessages = (): ModelMessage[] => [
